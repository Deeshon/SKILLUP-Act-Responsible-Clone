...
const AwarenessItem = ({item}: {item: {number: string; title: string; buttonTitle: string;}}) => {
  ...
  return (
    ...
    <button className="bg-red-000 px-5 py-2 rounded-3xl text-white font-bold">{buttonTitle}</button>
  </div>
  )
}
